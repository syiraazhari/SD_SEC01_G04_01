            ...
            <div class="row m-l-0 m-r-0" style="width:100%;">
                <div class="col-sm-4 bg-c-lite-green user-profile">
                    <div class="card-block text-center text-white" style="margin-left:10px">
                        ...
                        <p style="font-size: 20px;">- Voter -</p>
                    ...
                    <div class="card-block">
                        ...
                        <div class="row">
                            <div class="update ml-auto mr-auto">
                                <a href="{{ url('voter/profiles/edit/' . $user->profile->user_id) }}" class="btn btn-round"
                                    style="background-color: #f8a617; color: white;">Edit Profile</a>
                            </div>
                        </div>
                    </div>
                </div>
