      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-title" style="text-align: center;">- Please choose one (<b>1</b>) candidate only for the General Seat.</p><br>
            <p class="card-title" style="text-align: center;">2) School / Faculty Seat</p>
            <p class="card-title" style="text-align: center;">- Please choose one (<b>1</b>) candidate only for School / Faculty Seats.</p><br><br>
