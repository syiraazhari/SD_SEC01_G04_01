...
@section('content2')
    ...
    <div class="row" style="padding-top: 0rem;margin: auto; width:100%">
            ...
            <div class="banner">
                        <h1 style="font-size:50px; color: #F8A617; font-weight: 630;padding: 105px 0;text-align: center;margin: auto;width: 60%;">MPP Alumni</h1>
                </div>
                ...
                <section class="mb-4 card card-body" style="border:white;">
                    ...
                    <form action="{{ url('update-mppalumni/' . $alumni->id) }}" method="POST"
                        style="margin-left: 80px; margin-right: 80px;">
                        @csrf
                        @method('POST')
                        <textarea name="content" cols="40" rows="5" placeholder="Enter mpp alumni caption"
                            style="height: 130px; width: 100%;">{{ $alumni->content }}</textarea>
                    ...
                    <div class="container" style="padding-left: 40px; padding-right: 40px;">
                        ...
                        {{-- <p style="text-align: justify;"> UTM Student Representative Council (SRC) is a Centrer association
                            representing all university registered students.
                            The SRC is formed through the election process each year to select candidates representing the
                            general and faculty chairs of the university.
                            All registered students who are pursuing diploma and degree courses are eligible to vote and
                            have the right to elect representatives to fill the general
                            and faculty seats as their representatives in the SRC. <br><br>

                            The Executive Council’s main task is to act as the forefront to the leadership line of MPP UTM.
                            Not only that, the Executive Council also monitors the job scopes and tasks of each department
                            in MPP so that it is well integrated with all the other departments of MPP.
                            The Executive Council also plays a big role in ensuring that all the tasks being fulfilled are
                            based on the mission of MPP which is our utmost priority.
                        </p> --}}
