{{-- ADMIN VOTING CONTENT (FTIR SEAT VOTING)--}}
{{-- NEXT: MJIIT SEAT VOTING --}}
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            ...
            <h5 class="card-title" style="text-align: center;">Razak Faculty of technology and Informatics (FTIR)</h5><br>
          </div>
          <div class="card-body">
          ...
          <div class="container" style="text-align: center;"> 
            <a href= "{{ url('adminpanel/votingpage/votingahibs') }}" class ="button"> < Previous Seat </a>   
            <a href= "{{ url('adminpanel/votingpage/votingmjiit') }}" class ="button"> View Next Seat > </a>
            </div>  
