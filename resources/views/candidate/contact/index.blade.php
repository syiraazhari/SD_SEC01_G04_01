            ...
            <div class="col-md-12">
                ...
                <section class="mb-4 card card-body" style="border:white">
                    ...
                    <p class="text-center w-responsive mx-auto mb-5">We'd really appreciate it if you took some time to rate
                        your experience in using this website. Any comments will be taken into consideration to hopefully
                        better this
                    ...
                    <div class="row" style="margin:auto">
                        ...
                        <div class="col-md-9 mb-md-0 mb-5">
                            <form id="contact-form" name="contact-form" action="{{ url('candidateFeedback') }}"
                                method="POST">
                                @csrf
                                <!--Grid row-->
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="md-form mb-0">
                                            <label style="font-size:1.0rem">How would you rate your overall
                                                experience?</label>
                                            <br>
                                            <div class="btn-group-toggle" data-toggle="buttons">
                                                <label class="btn btn-secondary btn-danger active btn-lg"
                                                    style="margin-right:15px">
                                                    <i class="fa-solid fa-face-frown fa-xl"></i>
                                                    <input type="radio" name="poor" value="1"{{-- id="poor" --}}
                                                        autocomplete="off">
                                                </label>

                                                <label class="btn btn-secondary btn-warning btn-lg"
                                                    style="margin-right:15px">
                                                    <i class="fa-solid fa-face-meh fa-xl"></i>
                                                    <input type="radio" name="average" value="1"{{-- id="average" --}}
                                                        autocomplete="off">
                                                </label>

                                                <label class="btn btn-secondary btn-success btn-lg"
                                                    style="margin-right:15px">
                                                    <i class="fa-solid fa-face-smile fa-xl"></i>
                                                    <input type="radio" name="good" value="1"{{-- id="good" --}}
                                                        autocomplete="off">
                                                </label>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="md-form">
                                            <input type="text" id="comment" name="comment" rows="2"
                                                class="form-control md-textarea">
                                            <label for="message" style="font-size:1.0rem">Comments / Suggestions /
                                                Feedback</label>
                                        </div>
                                    </div>
                                </div>
