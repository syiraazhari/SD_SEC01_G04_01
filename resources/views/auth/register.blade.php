...
<body style="background-color:#fff; height: 100%; background-size: cover;">
    ...
    <div class="wrapper">
			...
			<div class="inner">
				<div class="image-holder" style="background-image: url(assets/img/signin.png); background-size: 90%; background-color: #e89a13; background-repeat: no-repeat; background-position: center center;">
